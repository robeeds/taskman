...
export default function SideNav() {
  ...
  return (
    <div className="bg-bgSecondary z-[5] flex w-full flex-1 flex-row items-center p-4 md:flex-col md:items-start">
      {/* Username Section with Gear Icon (Settings) */}
      <div className="bg-bgPrimary flex flex-row rounded-l-[15px] p-3 md:w-full md:items-center md:justify-between md:rounded-t-[15px] md:rounded-bl-none md:rounded-tr-none">
